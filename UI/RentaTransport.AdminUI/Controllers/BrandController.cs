...
{
    public class BrandController : CrudController<BrandViewModel,BrandServiceFacade,BrandDTO,IBrandRepository,BrandValidator,BrandService>
    {
        public BrandController(BrandServiceFacade brandServiceFacade):base(brandServiceFacade)
        {
        }
    }
}